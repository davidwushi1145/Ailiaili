...
CREATE TABLE `t_ad_performance` (
  ...
  CONSTRAINT `fk_ad_performance_advertisement` FOREIGN KEY (`ad_id`) REFERENCES `t_advertisement` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='广告性能表';
...
CREATE TABLE `t_ad_space` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='广告位表';
...
CREATE TABLE `t_advertisement` (
  ...
  CONSTRAINT `fk_advertisement_content` FOREIGN KEY (`content_id`) REFERENCES `t_file` (`id`)
...
CREATE TABLE `t_auth_role_element_operation` (
  ...
  CONSTRAINT `fk_role_element_operation_role_id` FOREIGN KEY (`role_id`) REFERENCES `t_auth_role` (`id`)
...
CREATE TABLE `t_auth_role_menu` (
  ...
  CONSTRAINT `fk_role_menu_role_id` FOREIGN KEY (`role_id`) REFERENCES `t_auth_role` (`id`)
...
CREATE TABLE `t_collection_group` (
  ...
  CONSTRAINT `fk_collection_group_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1001 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户收藏分组表';
...
CREATE TABLE `t_danmu` (
  ...
  CONSTRAINT `fk_danmu_video_id` FOREIGN KEY (`video_id`) REFERENCES `t_video` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='弹幕表';

-- ----------------------------
-- Records of t_danmu
-- ----------------------------
BEGIN;
INSERT INTO `t_danmu` (`id`, `user_id`, `video_id`, `content`, `danmu_time`, `create_time`) VALUES (2, 3, 13, '123', NULL, '2023-11-28 16:23:23');
COMMIT;
...
CREATE TABLE `t_messages` (
  ...
  CONSTRAINT `fk_messages_sender` FOREIGN KEY (`sender_id`) REFERENCES `t_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='消息通信表';
...
CREATE TABLE `t_partnership` (
  ...
  CONSTRAINT `fk_partnership_creator` FOREIGN KEY (`creator_id`) REFERENCES `t_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='合作关系表';
...
CREATE TABLE `t_partnership_requests` (
  ...
  CONSTRAINT `fk_partnership_requests_creator` FOREIGN KEY (`content_creator_id`) REFERENCES `t_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='合作请求表';
...
CREATE TABLE `t_refresh_token` (
  ...
  CONSTRAINT `fk_refresh_token_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='刷新令牌记录表';

-- ----------------------------
-- Records of t_refresh_token
-- ----------------------------
BEGIN;
INSERT INTO `t_refresh_token` (`id`, `user_id`, `refresh_token`, `create_time`) VALUES (9, 3, 'eyJraWQiOiIzIiwidHlwIjoiSldUIiwiYWxnIjoiUlMyNTYifQ.eyJpc3MiOiLnrb7lj5HogIUiLCJleHAiOjE3MDIwOTE4ODN9.JtALMd-laeS76MZp1xYVzqtHpAvRns__9esuyitw_u0H5rCGosQCGmwP10888rE9Tli4xWFTH5FZ7CVVaA4kSTSxD2w74Fg0PdJjeWESIBlFG6IPg7O8XSaA7Qli1fley539O_wJBQuCq0iA6QOPzzR06PNb4k70fV0Yi0SVoFg', '2023-12-02 11:18:03');
...
INSERT INTO `t_user` (`id`, `phone`, `email`, `user_password`, `salt`, `create_time`, `update_time`) VALUES (3, '1', NULL, '137ade7680450d1148e7d1da802dbc34', '1700791570711', '2023-11-24 10:06:10', '2023-11-24 10:06:10');
COMMIT;
...
CREATE TABLE `t_user_coin` (
  ...
  CONSTRAINT `fk_user_coin_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `t_user_coin` (`id`, `user_id`, `amount`, `create_time`, `update_time`) VALUES (1, 3, 0, '2023-11-24 10:06:10', '2023-11-24 10:06:10');
COMMIT;
...
CREATE TABLE `t_user_following` (
  ...
  CONSTRAINT `fk_user_following_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
...
CREATE TABLE `t_user_info` (
  ...
  CONSTRAINT `fk_user_info_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
...
-- ----------------------------
BEGIN;
INSERT INTO `t_user_info` (`id`, `user_id`, `nick`, `avatar`, `sign`, `gender`, `birth`, `create_time`, `update_time`) VALUES (1, 1, '牛逼', NULL, NULL, '1', '2000-01-01', '2023-01-23 03:41:54', '2023-11-24 10:07:16');
...
INSERT INTO `t_user_info` (`id`, `user_id`, `nick`, `avatar`, `sign`, `gender`, `birth`, `create_time`, `update_time`) VALUES (3, 3, '萌新', NULL, NULL, '2', '2000-01-01', '2023-11-24 10:06:10', '2023-11-24 10:06:10');
COMMIT;
...
CREATE TABLE `t_user_moments` (
  ...
  CONSTRAINT `fk_user_moments_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
...
INSERT INTO `t_user_role` (`id`, `user_id`, `role_id`, `create_time`) VALUES (3, 3, 1, '2023-11-24 10:06:10');
COMMIT;
...
CREATE TABLE `t_video` (
  ...
  CONSTRAINT `fk_video_user_id` FOREIGN KEY (`user_id`) REFERENCES `t_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=29 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='视频投稿记录表';

-- ----------------------------
-- Records of t_video
-- ----------------------------
BEGIN;
INSERT INTO `t_video` (`id`, `user_id`, `url`, `thumbnail`, `title`, `type`, `duration`, `area`, `description`, `create_time`, `update_time`) VALUES (1, 1, 'url1', 'thumbnail1', 'Video 1', '0', '10min', '0', 'Description 1', '2023-12-02 11:45:16', '2023-12-02 11:45:16');
INSERT INTO `t_video` (`id`, `user_id`, `url`, `thumbnail`, `title`, `type`, `duration`, `area`, `description`, `create_time`, `update_time`) VALUES (2, 2, 'url2', 'thumbnail2', 'Video 2', '1', '20min', '1', 'Description 2', '2023-12-02 11:45:16', '2023-12-02 11:45:16');
INSERT INTO `t_video` (`id`, `user_id`, `url`, `thumbnail`, `title`, `type`, `duration`, `area`, `description`, `create_time`, `update_time`) VALUES (3, 3, 'url3', 'thumbnail3', 'Video 3', '0', '30min', '2', 'Description 3', '2023-12-02 11:45:16', '2023-12-02 11:45:16');
...
INSERT INTO `t_video` (`id`, `user_id`, `url`, `thumbnail`, `title`, `type`, `duration`, `area`, `description`, `create_time`, `update_time`) VALUES (28, 3, 'abcde', 'abcde', 'good', '0', '199', '0', 'no', '2023-11-28 15:17:33', '2023-11-28 15:17:33');
COMMIT;
...
CREATE TABLE `t_video_coin` (
  ...
  CONSTRAINT `fk_video_coin_video_id` FOREIGN KEY (`video_id`) REFERENCES `t_video` (`id`)
...
CREATE TABLE `t_video_collection` (
  ...
  CONSTRAINT `fk_video_collection_video_id` FOREIGN KEY (`video_id`) REFERENCES `t_video` (`id`)
...
CREATE TABLE `t_video_comment` (
  ...
  CONSTRAINT `fk_video_comment_video_id` FOREIGN KEY (`video_id`) REFERENCES `t_video` (`id`)
...
CREATE TABLE `t_video_like` (
  ...
  CONSTRAINT `fk_video_like_video_id` FOREIGN KEY (`video_id`) REFERENCES `t_video` (`id`)
...
CREATE TABLE `t_video_operation` (
  ...
  CONSTRAINT `fk_video_operation_video_id` FOREIGN KEY (`video_id`) REFERENCES `t_video` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='用户操作表';

-- ----------------------------
-- Records of t_video_operation
-- ----------------------------
BEGIN;
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (1, 1, 17, '0', '2009-12-18 17:23:16');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (2, 2, 21, '1', '2021-06-07 03:08:25');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (3, 2, 23, '2', '2009-04-21 16:47:22');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (4, 3, 15, '3', '2010-11-14 17:37:33');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (5, 1, 26, '1', '2008-06-21 00:18:27');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (6, 3, 15, '2', '2000-08-12 08:44:08');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (7, 1, 15, '1', '2016-10-04 21:36:15');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (8, 1, 16, '2', '2018-11-13 21:29:13');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (9, 3, 19, '1', '2018-02-23 08:15:09');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (10, 1, 28, '2', '2017-10-22 16:02:33');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (11, 1, 1, '0', '2023-12-02 11:45:25');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (12, 1, 2, '1', '2023-12-02 11:45:25');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (13, 2, 1, '2', '2023-12-02 11:45:25');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (14, 2, 3, '0', '2023-12-02 11:45:25');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (15, 3, 2, '1', '2023-12-02 11:45:25');
INSERT INTO `t_video_operation` (`id`, `user_id`, `video_id`, `operation_type`, `create_time`) VALUES (16, 3, 3, '2', '2023-12-02 11:45:25');
COMMIT;
...
CREATE TABLE `t_video_tag` (
  ...
  CONSTRAINT `fk_video_tag_video_id` FOREIGN KEY (`video_id`) REFERENCES `t_video` (`id`)
...
CREATE TABLE `t_video_view` (
  ...
  CONSTRAINT `fk_video_view_video_id` FOREIGN KEY (`video_id`) REFERENCES `t_video` (`id`)
